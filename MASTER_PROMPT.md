...
`expected_evidence` có thể dùng JSONB.

`evaluation_guide` có thể dùng JSONB.
...
Reject grading submission hoặc cho phép lưu nhưng status không được READY_FOR_GRADING.

Khuyến nghị:

Cho phép lưu submission nhưng không grading trước khi rubric lock.
...
Sau parsing tạo một object tổng hợp:
...
DATABASE_URL=postgresql+psycopg://postgres:postgres@db:5432/ai_grading
...
Phải tạo migration initial đầy đủ.
...
6. Không bỏ code ở trạng thái broken.

---

# LXXVI. KHÔNG ĐƯỢC LÀM
...
# LXXVIII. PRODUCTION V1 DEFINITION OF DONE

Không tuyên bố hoàn thành cho đến khi tất cả điều sau đạt:

* [ ] FastAPI starts successfully.
* [ ] PostgreSQL works.
* [ ] Alembic initial migration works.
...
Nếu Docker không chạy được trong môi trường hiện tại:
...
# LXXX. FINAL DELIVERY FROM CODEX
...
> **Fairness, consistency, evidence, auditability, security và khả năng chạy production.**
